      ...
      <ul>
        {products.map((product) => (
          <li key={product.id} style={{ marginBottom: "1rem" }}>
            ...
            <input type="text" value={product.brand} onChange={(e) => handleProductChange(product.id, "brand", e.target.value)} />
            <input type="text" value={product.description} onChange={(e) => handleProductChange(product.id, "description", e.target.value)} />
            <input type="number" value={product.price} onChange={(e) => handleProductChange(product.id, "price", e.target.value)} />
